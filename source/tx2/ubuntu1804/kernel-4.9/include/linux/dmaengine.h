...
struct dma_device {
	...
	int (*device_alloc_chan_resources)(struct dma_chan *chan);  // dma_chan_get 里调用 
	                                                            // tsi721 : tsi721_alloc_chan_resources
	void (*device_free_chan_resources)(struct dma_chan *chan);  //  tsi 721 : tsi721_free_chan_resources
	...
	struct dma_async_tx_descriptor *(*device_prep_slave_sg)(   // dmaengine_prep_rio_sg 里调用
		struct dma_chan *chan, struct scatterlist *sgl,
		unsigned int sg_len, enum dma_transfer_direction direction,
		unsigned long flags, void *context);                          // tsi721 : tsi721_prep_rio_sg
	...
	int (*device_terminate_all)(struct dma_chan *chan);    // tsi721 : tsi721_terminate_all
...
// rio_dma_prep_xfer -> dmaengine_prep_rio_sg
struct rio_dma_ext;
