 ...
 */
// tsi721_setup_mport -> rio_init_mbox_res
// rio_request_outb_mbox -> rio_init_mbox_res
 ...
 */
// tsi721_setup_mport -> rio_init_dbell_res
// rio_request_inb_dbell -> rio_init_dbell_res
				       ...
				       void *buffer, size_t len)
{
	return mport->ops->add_outb_message(mport, rdev, mbox,
						   buffer, len);   // tsi721    tsi721_add_outb_message
}
 ...
 * 0 on success.
 */
// riocm_rx_fill -> rio_add_inb_buffer
static inline int rio_add_inb_buffer(struct rio_mport *mport, int mbox,
				     void *buffer)
{
	return mport->ops->add_inb_buffer(mport, mbox, buffer);   // tsi721   tsi721_add_inb_buffer
}
 ...
 */
// riocm_rx_get_msg -> rio_get_inb_message
// rionet_rx_clean -> rio_get_inb_message     rionet 收包流程
static inline void *rio_get_inb_message(struct rio_mport *mport, int mbox)
{
	return mport->ops->get_inb_message(mport, mbox);   // tsi721 : tsi721_get_inb_message
}
