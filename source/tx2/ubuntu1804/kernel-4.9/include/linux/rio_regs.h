...
#define RIO_DID_CSR		0x60	/* [III] Base Device ID CSR */
                                /* This is a global device register that supports ingress packet filtering based on destID. 
                                   It contains the base deviceID values for the device. 
                                   A device may have multiple deviceID values but these are not defined in a standard CSR.  */
                                // user manual page 510
