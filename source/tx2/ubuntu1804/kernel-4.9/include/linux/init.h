...
#define __define_initcall(fn, id) \
	...
	__attribute__((__section__(".initcall" #id ".init"))) = fn;   // section name .initcall3   .initcall3s
	                                                            //  .initcall3  .initcall3s 对应的address是 __initcall3_start      3排在3s前面
 ...
 */
#define early_initcall(fn)		__define_initcall(fn, early)     // kernel_init -> kernel_init_freeable -> do_pre_smp_initcalls -> do_one_initcall
