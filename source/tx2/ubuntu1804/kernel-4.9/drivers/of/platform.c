 ...
 */
// of_device_alloc -> of_device_make_bus_id
 ...
 */
// of_platform_default_populate -> of_platform_populate
...
#ifndef CONFIG_PPC
// do_one_initcall -> of_platform_default_populate_init
...
arch_initcall_sync(of_platform_default_populate_init);   // 初始化时候调用        kernel_init -> kernel_init_freeable -> do_one_initcall -> of_platform_default_populate_init 
#endif
