...
/// tegra_pcie_parse_dt -> of_pci_range_parser_init
 ...
 */
// tegra_pcie_parse_dt -> of_pci_range_to_resource
...
// of_address_to_resource -> __of_address_to_resource
static int __of_address_to_resource(struct device_node *dev,
		const __be32 *addrp, u64 size, unsigned int flags,
		const char *name, struct resource *r)
{
 ...
 */
// of_device_alloc -> of_address_to_resource
