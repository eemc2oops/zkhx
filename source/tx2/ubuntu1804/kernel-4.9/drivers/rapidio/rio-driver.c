...
// rio_mport_add_riodev -> rio_attach_device
...
// rio_mport.dev.class 指向本结构   rio_register_mport
// rapidio 字符接口 rio_mport_interface 的 class
// rio_cm 接口 rio_mport_interface 的 class
// rionet 接口 rio_mport_interface 的 class
...
// rio_attach_device
// rio_mport_add_riodev 查找总线下挂的设备
