 ...
 */
// mport_write -> rio_mport_send_doorbell
int rio_mport_send_doorbell(struct rio_mport *mport, u16 destid, u16 data)
{
	...
	res = mport->ops->dsend(mport, mport->id, destid, data);  // tsi721 : tsi721_dsend
