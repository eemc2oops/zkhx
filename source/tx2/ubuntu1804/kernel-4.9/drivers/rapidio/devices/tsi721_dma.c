...
// tsi721_alloc_chan_resources -> tsi721_bdma_ch_init
 ...
 */
// tsi721_bdma_ch_init 里挂的中断处理函数
static irqreturn_t tsi721_bdma_msix(int irq, void *ptr)
{
	struct tsi721_bdma_chan *bdma_chan = ptr;

	if (bdma_chan->active)
		tasklet_hi_schedule(&bdma_chan->tasklet);    //  激活 tsi721_dma_tasklet
	return IRQ_HANDLED;
}
#endif /* CONFIG_PCI_MSI */

/* Must be called with the spinlock held */
// tsi721_advance_work -> tsi721_start_dma
...
// tsi721_advance_work -> tsi721_submit_sg
static int tsi721_submit_sg(struct tsi721_tx_desc *desc)
{
...
// dma_chan_get -> tsi721_alloc_chan_resources
...
// dmaengine_prep_rio_sg -> tsi721_prep_rio_sg
static
...
// tsi721_setup_mport -> tsi721_register_dma
