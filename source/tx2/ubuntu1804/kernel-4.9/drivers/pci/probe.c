 ...
 */
// pci_read_bases -> __pci_read_base
...
// pci_register_host_bridge -> pci_alloc_bus
// pci_alloc_child_bus -> pci_alloc_bus
...
// tegra_pcie_probe -> pci_alloc_host_bridge
...
// tegra_pcie_init -> pci_register_host_bridge
int pci_register_host_bridge(struct pci_host_bridge *bridge)
{
	...
	err = device_register(&bridge->dev);  // bridge->dev bus 是NULL
	if (err)
	...
	err = device_register(&bus->dev);  // bus->dev bus 是NULL
	if (err)
		goto unregister;
...
// pci_add_new_bus -> pci_alloc_child_bus
...
add_dev:
	...
	if (child->ops->add_bus) {   // tegra_pcie_add_bus
...
// pci_scan_bridge -> pci_add_new_bus
 ...
 */
// pci_scan_child_bus -> pci_scan_bridge
...
// pci_device_add -> pci_configure_device
 ...
 */
// pci_device_add -> pci_dma_configure
 ...
 */
// pci_scan_child_bus -> pci_scan_slot
...
// tegra_pcie_init -> pci_scan_child_bus
...
// pci_register_host_bridge -> pci_bus_insert_busn_res
