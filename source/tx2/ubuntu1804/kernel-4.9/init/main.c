...
char __initdata boot_command_line[COMMAND_LINE_SIZE];  // early_init_dt_scan_nodes 里，把dts里的cmdline配置增加到这里
...
// do_pre_smp_initcalls -> do_one_initcall    early_initcall
// do_initcall_level -> do_one_initcall   initcall0 ~ initcall7
...
// kernel_init_freeable -> do_pre_smp_initcalls
