...
static char dump_stack_arch_desc_str[128];  // dump_stack_set_arch_desc     tx2里该字符串的值是 "quill (DT)"   "quill" 是从DTB里解析出来的 of_flat_dt_get_machine_name
 ...
 */
// setup_machine_fdt -> dump_stack_set_arch_desc
